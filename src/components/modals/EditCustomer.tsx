...
function EditCustomer({ isOpen, onClose, onSubmit, customerData }: EditCustomerProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    onSubmit(formData);
    setFormData({companyName: "", contactPerson: "", email: "", phone: "", address: "", subscriptionPlan: "", startTime: "", endTime: ""});
    onClose();
  }
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-3 text-black py-2 te  border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500"
